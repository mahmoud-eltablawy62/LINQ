...
class unitofstock : IComparer<Product>
{
...
class MyEqualityComarer : IEqualityComparer<Product>
{
    ...
    public override bool Equals(object ? obj)
    {
        ...
        if (other == null)  return false; 
            ...
            return this.ProductID == other.ProductID && this.ProductName == other.ProductName &&
               this.UnitsInStock == other.UnitsInStock && this.UnitPrice == other.UnitPrice &&
